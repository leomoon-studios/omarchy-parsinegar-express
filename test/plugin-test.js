...
assert.ok(exportSection.includes('Controls.ScrollView'));
assert.ok(exportSection.includes('contentHeight: exportCard.height'));
assert.ok(exportSection.includes('exportVerticalBar.width + Style.space(6)'));
assert.ok(exportSection.includes('active: exportScroll.overflowing'));
