...
assert.ok(panel.includes('property int editorFontSize: Style.font.body'));
...
assert.ok(textEditorContextMenu.includes('width: control.availableWidth'));
assert.ok(textEditorContextMenu.includes('horizontalAlignment: root.rightToLeft ? Text.AlignRight : Text.AlignLeft'));
assert.ok(textEditorContextMenu.includes('x: root.rightToLeft ? 0 : parent.width - width'));
...
assert.ok(settings.includes('leftPadding: root.rightToLeft ? scrollGutter : 0'));
assert.ok(settings.includes('rightPadding: root.rightToLeft ? 0 : scrollGutter'));
...
assert.ok(settings.includes('readonly property bool rightToLeft: controller.uiLanguage === "fa" || controller.uiLanguage === "ar"'));
assert.ok(settings.includes('columns: 3'));
assert.ok(settings.includes('language.arabic'));
...
assert.ok(menu.includes('layoutDirection: root.rightToLeft ? Qt.RightToLeft : Qt.LeftToRight'));
...
assert.ok(menu.includes('Layout.minimumHeight: Style.space(180)'));
...
assert.ok(menu.includes('leftPadding: root.rightToLeft ? scrollGutter : 0'));
assert.ok(menu.includes('rightPadding: root.rightToLeft ? 0 : scrollGutter'));
...
assert.ok(menu.includes('function adjustEditorFontSize(delta)'));
assert.ok(menu.includes('onWheel: function(wheel)'));
...
assert.ok(menu.includes('readonly property bool rightToLeft: uiLanguage === "fa" || uiLanguage === "ar"'));
assert.ok(menu.includes('LayoutMirroring.enabled: root.rightToLeft'));
assert.ok(menu.includes('id: editorScroll'));
assert.match(menu, /ColumnLayout\s*\{\s*id: formColumn/);
assert.ok(menu.includes('height: Math.max(implicitHeight, formScroll.availableHeight)'));
assert.ok(menu.includes('contentHeight: formColumn.height'));
assert.ok(menu.includes('Layout.fillHeight: true'));
...
assert.ok(settings.includes('LayoutMirroring.enabled: rightToLeft'));
...
assert.match(exportSection, /id: heightField[\s\S]*enabled: !root\.automaticHeight/);
assert.ok(textToolsPage.includes('ScrollView'));
assert.ok(textToolsPage.includes('LayoutMirroring.enabled: rightToLeft'));
...
assert.ok(helpPage.includes('readonly property var arabicSections'));
assert.ok(helpPage.includes('horizontalAlignment: root.rightToLeft ? Text.AlignRight : Text.AlignLeft'));
...
assert.doesNotMatch(exportSection, /TextTools|applyTextToolsToSource/);
