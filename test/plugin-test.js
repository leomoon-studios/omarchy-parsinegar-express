...
assert.ok(menu.includes('Ui.PanelActionButton'));
...
assert.ok(menu.includes('function paragraphDirections'));
assert.ok(menu.includes('function directionSignature'));
assert.ok(menu.includes('requestedSignature !== root.editorDirectionSignature'));
