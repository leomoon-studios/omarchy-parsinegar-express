...
var InterfaceStrings = (function () {
  ...
  var values = {
    en: {
      ...
      "settings.languageLabel.Arabic": "Persian/Arabic", "settings.languageLabel.Kurdish": "Kurdish/Urdu",
      "settings.languageDescription.Arabic": "Uses standard Unicode letter forms for Persian and Arabic.",
      "settings.languageDescription.Kurdish": "Uses alternative Kurdish and Urdu letter forms. Some glyphs require a compatible font.",
    ...
    fa: {
      ...
      "settings.languageLabel.Arabic": "پارسی/عربی", "settings.languageLabel.Kurdish": "کردی/اردو",
      "settings.languageDescription.Arabic": "از شکل‌های استاندارد یونیکد حروف برای پارسی و عربی استفاده می‌کند.",
      "settings.languageDescription.Kurdish": "از شکل‌های جایگزین حروف کردی و اردو استفاده می‌کند؛ برخی گلیف‌ها به فونت سازگار نیاز دارند.",
